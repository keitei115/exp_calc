var calcRequirdCandy = function (requiredEXP, xlLimit, lLimit, mLimit, sLimit, xsLimit) {
    var xls = 0;
    var ls = 0;
    var ms = 0;
    var ss = 0;
...
var ans = calcRequirdCandy(1640000, 10, 100, 100, 100, 100);
console.log(ans[0] + " " + ans[1] + " " + ans[2] + " " + ans[3] + " " + ans[4] + " " + ans[5] + " " + ans[6]);